...
opt_params = param_df.iloc[0][:]
opt_params_df = pd.DataFrame(opt_params).T
opt_params_df=opt_params_df.drop(['rank','rmse'],axis=1)
opt_params_df.columns = ['alpha','fit_intercept','l1_ratio','normalize','time','tol']
